          ...
          <div className="p-6">
            <div className="flex items-center gap-3 rounded-2xl bg-white/5 p-3 transition-colors hover:bg-white/10">
              ...
              <div className="flex-1 overflow-hidden">
                ...
                <div className="truncate text-xs text-[#8B8D98]">{user.email}</div>
              </div>
              <Button variant="ghost" size="icon" className="h-8 w-8 text-[#8B8D98] hover:text-white" onClick={() => signOut()}>
